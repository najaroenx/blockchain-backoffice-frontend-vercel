    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-[#1a1a2e] rounded-2xl border border-white/5 shadow-sm p-6">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#1a1a2e] border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm text-white"
                />
                ...
                {showSearchDropdown &&
                  ...
                  filteredProducts?.length > 0 && (
                    <div className="absolute top-full left-0 right-0 mt-2 bg-[#1a1a2e] border border-white/10 rounded-xl shadow-lg z-10 max-h-80 overflow-y-auto">
                      {filteredProducts?.map((product) => (
                        <div
                          key={product.id}
                          onClick={() => handleAddProductFromSearch(product)}
                          className="flex items-center gap-3 px-4 py-3 hover:bg-white/5 cursor-pointer transition-colors first:rounded-t-xl last:rounded-b-xl"
                        >
                          {/* Product Image */}
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-xl hover:from-purple-700 hover:to-pink-700 transition-colors shadow-sm shadow-purple-500/25"
              >
                Browse products
              </button>
            </div>
                ...
                <tbody>
                  {selectedProducts.length === 0 ? (
                    ...
                    selectedProducts.map((product) => (
                      <tr
                        key={product.id}
                        className="border-b border-slate-50 hover:bg-white/5"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm text-white"
                />
              </div>
                ...
                <div className="flex gap-3">
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none px-4 py-3 pr-10 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm text-white"
                    >
                    ...
                    <KeyboardArrowDownIcon className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none w-5 h-5" />
                  </div>
                  <input
                    type="tel"
                    id="phoneNumber"
                    ...
                    onChange={handleInputChange}
                    className="flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm text-white"
                  />
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none px-4 py-3 pr-10 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm text-white"
                  >
                ...
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                    <div className="w-5 h-5 bg-purple-500/20 rounded flex items-center justify-center">
                      <PaymentOutlinedIcon className="w-3 h-3 text-purple-400" />
                    </div>
                  </div>
                  <select
                    id="paymentMethod"
                    ...
                    className="w-full appearance-none pl-12 pr-10 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm text-white"
                  >
      ...
      <div className="fixed bottom-0 left-0 lg:left-64 right-0 bg-[#1a1a2e] border-t border-white/10 px-6 py-4 z-40">
        <div className="max-w-7xl mx-auto flex items-center justify-end gap-4">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium hover:from-purple-700 hover:to-pink-700 shadow-sm shadow-purple-500/25 transition-all"
          >
            Create
          </button>
        </div>
